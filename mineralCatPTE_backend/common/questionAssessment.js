...
function buildAnswerShortQuestionAssessment(payload = {}) {
  ...
  return buildAssessment({
    ...
    score: roundScore(average([speakingRaw, listeningRaw]) ?? 0, 2),
    maxScore: 1,
    skills: [
      buildMetric({
        key: "speaking",
        label: "Speaking",
        score: roundScore(speakingRaw, 2),
        maxScore: 1,
      ...
      buildMetric({
        key: "listening",
        label: "Listening",
        score: roundScore(listeningRaw, 2),
        maxScore: 1,
    ...
    traits: [
      ...
      buildMetric({
        key: "pronunciation",
        label: "Pronunciation",
        score: roundScore(pronunciationRaw, 2),
        maxScore: 1,
